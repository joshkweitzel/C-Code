...
/*
   Function that displays 3 posts for a given user.
   After displaying 3 posts, it prompts if you want to display
   more posts.
...
//Prints the new updated menu which displays before the main menu
void print_usermenu(user_t *user);

//Return string entered by a user in lowercase
char * lower_case(char *string);

//Prompts the user to enter a string. Select chooses the # of chars (15 or 32)
